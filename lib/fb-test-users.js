...
FBTestUsers.prototype.list = function(limit, callback){
  var that = this;
  ...
  this.getAccessToken(function(error, access_token){
    var url = 'https://graph.facebook.com/' + that.appID + '/accounts/test-users' + '?limit=' + limit;
    var qs = {
...
FBTestUsers.prototype.create = function(args, callback){
  var that = this;
  args = args || {};
  args.installed = ('installed' in args) ? args.installed : true;
